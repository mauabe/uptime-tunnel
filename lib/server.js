...
server.unifiedServer = function(req,res){
   ...
   req.on('end', function() {
      ...
      try{
        ...
        debug(e);
        server.processHandlerResponse(res, method, trimmedPath,500, {'Error':'Unknown error just happened for aparently no reason'}, 'json');
      }
   });
 };
...
server.processHandlerResponse = function(res, method, trimmedPath, statusCode, payload, contentType){
  //determine the type of response (falback to JSON)
