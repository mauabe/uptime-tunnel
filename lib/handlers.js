...
handlers.index = function(data, callback){
  ...
  if(data.method == 'get'){
    ...
    var templateData= {
      ...
      'head.description':'Simple uptime monitoring for HTTP/HTTPS for any website. When the website you are monitorig goes down, Uptime Tunnel will send you a text message alert.',
...
callback('something goes here, but I am lost.')
